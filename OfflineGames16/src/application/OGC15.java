...
public class OGC15 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        layout.getChildren().addAll(btnTicTacToe, btnSudokuSolver, btnSnakeGame, btnMinesweeper, btnBrickBreaker, btn2048Game, btnFlappyBird);
