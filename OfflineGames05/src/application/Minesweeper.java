...
public class Minesweeper extends Application {
    ...
    private void showMenu() {
        ...
        backButton.setOnAction(e -> primaryStage.close()); // Adjust this action to suit how your application transitions between screens.
        backButtonContainer.getChildren().add(backButton);
        backButtonContainer.setPadding(new Insets(20, 20, 20, 20)); // Add some padding to separate from the difficulty options

        menuRoot.setCenter(difficultyOptions);
        menuRoot.setBottom(backButtonContainer); // Set the back button at the bottom of the menuRoot
