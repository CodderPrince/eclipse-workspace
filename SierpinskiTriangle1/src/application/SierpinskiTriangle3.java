...
public class SierpinskiTriangle3 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		btnIncrease.setStyle("-fx-font-size: 30; -fx-text-fill: green;");
		...
		// Alternatively, if you want to control the padding individually:
		btnDecrease.setStyle("-fx-font-size: 18; -fx-text-fill: red; -fx-padding: 10px;");
		tfOrder.setStyle("-fx-font-family: 'Verdana'; -fx-font-size: 14; -fx-text-fill: black; -fx-prompt-text-fill: gray; -fx-border-color: gray; -fx-border-radius: 5; -fx-background-radius: 5; -fx-background-color: lightyellow; -fx-padding: 5px;");
		btnIncrease.setStyle("-fx-font-size: 18; -fx-text-fill: green; -fx-padding: 10px;");
