...
public class SudokuSolver {
    ...
    public void startApp(Stage primaryStage) {
        ...
        backButton.setStyle("-fx-background-color: linear-gradient(to right, #32CD32, #228B22); "
                + "-fx-background-radius: 30; -fx-padding: 10 20; -fx-border-radius: 30; "
                + "-fx-border-color: #32CD32; -fx-border-width: 2px;");

        backButton.setOnAction(event -> primaryStage.close()); // Close or navigate back

        // Solve Button
        Button solveButton = new Button("Solve");
        solveButton.setFont(Font.font("Arial", FontWeight.BOLD, 16));
        solveButton.setTextFill(Color.WHITE);
        solveButton.setStyle("-fx-background-color: linear-gradient(to right, #ff7f50, #ff6347); "
                + "-fx-background-radius: 30; -fx-padding: 10 20; -fx-border-radius: 30; "
                + "-fx-border-color: #ff4500; -fx-border-width: 2px;");
        solveButton.setOnAction(event -> solveSudoku());

        // Run Again Button
        Button runAgainButton = new Button("Run Again");
        runAgainButton.setFont(Font.font("Arial", FontWeight.BOLD, 16));
        runAgainButton.setTextFill(Color.WHITE);
        runAgainButton.setStyle("-fx-background-color: linear-gradient(to right, #6a0dad, #1e90ff); "
                + "-fx-background-radius: 30; -fx-padding: 10 20; -fx-border-radius: 30; "
                + "-fx-border-color: #4b0082; -fx-border-width: 2px;");
