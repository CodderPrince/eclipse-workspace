...
public class SudokuSolverApp02 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Create the 9x9 grid of text fields with gradient effect
        for (int row = 0; row < SIZE; row++) {
            for (int col = 0; col < SIZE; col++) {
                ...
                textField.setFont(Font.font("Arial", FontWeight.BOLD, 30                ));
                textField.setStyle("-fx-background-color: linear-gradient(to bottom right, #ffcccc, #ccffcc); " +
