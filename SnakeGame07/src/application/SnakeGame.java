...
public class SnakeGame extends Application {
    ...
    public void start(Stage stage) {
        ...
        playAgainButton.setStyle("-fx-font-size: 20px; -fx-background-color: linear-gradient(#ff7f50, #ff6347); -fx-text-fill: white; -fx-padding: 10px 20px;");
        playAgainButton.setLayoutX(WIDTH * TILE_SIZE / 2 - 100);
        ...
        Group root = new Group(canvas, playAgainButton);
