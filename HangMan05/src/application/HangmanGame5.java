...
public class HangmanGame5 extends Application {
    ...
    private Scene createGameScene(Stage primaryStage) {
        ...
        guessButton.setOnAction(event -> {
            ...
            if (!correctGuess) {
                ...
                messageLabel.setTextFill(Color.WHITE); // Set the text color to blue for incorrect guesses
            } else {
                messageLabel.setText("Correct guess!");
                messageLabel.setTextFill(Color.WHITE); // Set the text color to blue for correct guesses
            }
