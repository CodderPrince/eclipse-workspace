...
public class FlappyBird1 extends Application {
    ...
    private final double gravity = 0.3; // Slower gravity
    private final double jumpStrength = -10; // Adjusted jump strength
    ...
    private void update(GraphicsContext gc) {
        ...
        gc.fillOval(100, birdY, 20, 20);

        // Manage pipes
        long currentTime = System.currentTimeMillis();
        if (currentTime - lastPipeTime > 2500) { // Slower pipe generation
        ...
        while (iterator.hasNext()) {
            ...
            if (pipe[0] < 120 && pipe[0] + PIPE_WIDTH > 100) {
                if (birdY < pipe[1] || birdY + 20 > pipe[1] + PIPE_GAP) {
                    gameOver = true;
                }
            }
