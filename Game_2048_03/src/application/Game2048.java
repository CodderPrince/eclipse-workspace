...
public class Game2048 extends Application {
    ...
    public void start(Stage myStage) {
        ...
        // Handle key presses directly on the canvas
        game.setOnKeyPressed(event -> {
            ...
            if (!game.win && !game.lose) {
                switch (event.getCode()) {
                    ...
                    case DOWN -> game.down();
                    case UP -> game.up();
                    case H -> game.showHint(); // Update hint when "H" key is pressed
                }
            }
        ...
        new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (game.hint != null) {
                    ...
                    gc.fillText("Hint: Try moving " + game.hint, game.getWidth() / 2, game.getHeight() - 20);
                }
            }
        }.start();
    }
