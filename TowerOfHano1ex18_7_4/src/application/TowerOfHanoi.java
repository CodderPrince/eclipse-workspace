...
public class TowerOfHanoi extends Application {
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setTitle("Tower of Hanoi | Developed by PRINCE");
		primaryStage.show();
	}
	...
	private void towerOfHanoi(int n, int src, int helper, int dest) {
		...
		moveDisk(src, dest);// rest 1 disk source to destination | called moveDisk Function
