...
public class Game2048 extends Application {
    ...
    public void start(Stage myStage) {
        myStage.setTitle("Game 2048 with Hint");
    ...
    public static class Game extends Canvas {
        ...
        public void showHint() {
            // Basic heuristic: Try each direction and pick the one that changes the board most
            int maxScore = -1;
            String bestMove = "";

            Game copy = cloneGame();
            copy.left();
            if (copy.score > maxScore) {
                maxScore = copy.score;
                bestMove = "LEFT";
            }
            copy = cloneGame();
