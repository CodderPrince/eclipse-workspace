...
public class OGC18 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btnTowerOfHanoi = createStyledButton("Tower of Hanoi", "#ffd700", "#8b4513");
        ...
        layout.getChildren().addAll(btnTicTacToe, btnSudokuSolver, btnSnakeGame, btnMinesweeper, btnBrickBreaker, btn2048Game, btnFlappyBird, btnHangman, btnMemoryMatch, btnTowerOfHanoi);
    ...
    private void launchMemoryMatch() {
        //MemoryMatch memoryMatchApp = new MemoryMatch();
    ...
    private void launchTowerOfHanoi() {
        ...
        //towerOfHanoiApp.start(towerOfHanoiStage);
    }
