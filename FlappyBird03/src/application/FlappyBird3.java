...
public class FlappyBird3 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scene.setOnKeyPressed(event -> {
            if ((event.getCode() == KeyCode.SPACE || event.getCode() == KeyCode.UP) && !gameOver) {
