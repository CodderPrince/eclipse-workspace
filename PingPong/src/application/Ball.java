...
public class Ball extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String startDefaultStyle = "-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-font-size: 16px; -fx-padding: 10px;";
        ...
        Slider computerHeightSlider = new Slider(50, 200, 100);
    ...
    private void runGame(GraphicsContext graphicsContext, Canvas canvas) {
        ...
        if (gameStarted) {
            ...
            if (ballXPos < width - width / 4) {
                playerTwoYPos = ballYPos - computerHeight / 2;
            } else {
                playerTwoYPos = ballYPos > playerTwoYPos + computerHeight / 2 ? playerTwoYPos + 1 : playerTwoYPos - 1;
            }
