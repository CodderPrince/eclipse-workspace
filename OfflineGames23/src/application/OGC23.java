...
public class OGC23 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        leftColumn.getChildren().addAll(btnTicTacToe, btnSudokuSolver, btnSnakeGame, btnMinesweeper, btnBrickBreaker, btnBeanMachine);

        // Right column buttons
        VBox rightColumn = new VBox(20);
        rightColumn.getChildren().addAll(btn2048Game, btnFlappyBird, btnHangman, btnMemoryMatch, btnTowerOfHanoi, btnNCS);
        ...
        Scene scene = new Scene(layout, 610, 500);
