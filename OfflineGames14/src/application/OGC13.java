...
public class OGC13 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        layout.getChildren().addAll(btnTicTacToe, btnSudokuSolver, btnSnakeGame, btnMinesweeper, btnBrickBreaker, btn2048Game);
    ...
    private void launchBrickBreaker() {
        ...
        brickBreakerApp.launchGame(brickBreakerStage); // Call launchGame instead of start
    }
